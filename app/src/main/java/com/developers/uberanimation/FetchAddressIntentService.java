...
public class FetchAddressIntentService extends IntentService {
     ...
     * Note: We define a {@link ResultReceiver} in * WelcomeMainActivity to process content
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            for(int i = 0; i < address.getMaxAddressLineIndex(); i++) {
                ...
                addressFragments.add(address.getFeatureName()+" "+address.getThoroughfare()+"\n"+address.getLocality()+" "+address.getPostalCode());
                try
                {
                    JSONObject jsonObject=new JSONObject();
                    jsonObject.put("street1",address.getFeatureName());
                    jsonObject.put("street2",address.getThoroughfare());
                    ...
                    locationObj=lGson.fromJson(jsonObject.toString(), BeansPickAddress.class);
                }
            ...
            deliverResultToReceiver(Constants.SUCCESS_RESULT,
                    TextUtils.join(System.getProperty("line.separator"), addressFragments),locationObj,address);
        }
    }
    ...
    private void deliverResultToReceiver(int resultCode, String message,BeansPickAddress locationObj, Address address) {
        ...
        bundle.putParcelable("address", locationObj);
        bundle.putParcelable("addressText",address);
